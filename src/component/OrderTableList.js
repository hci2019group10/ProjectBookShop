  ...
  return (
    <div className="order_table_list_wrapper">
      <div className="order_table_list">
        <span className="order_table_list_header">ORDER LIST</span>
        <div className="content">
          ...
          >
            ...
            <TabPane tab="Wait for confirmation" key="2">
              {orderTablesWithStatus1.map((orderTable) => (
                <OrderTable key={orderTable.id} orderTableProps={orderTable} />
              ))}
            </TabPane>
            <TabPane tab="Are shipping" key="3">
